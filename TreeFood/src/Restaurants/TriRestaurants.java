 ...
 * @author ADMIN
 */
public class TriRestaurants extends javax.swing.JFrame {

    /**
     * Creates new form Food_Options
     */
    public TriRestaurants() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jt_Table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nombre", "Calificación", "Descripcion", "Foto"
            }
        ) {
        ...
        getContentPane().add(btn_Volver, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 390, 120, 30));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TriRestaurants.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TriRestaurants().setVisible(true);
            }
        });
    }
